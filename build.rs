...
fn main() {
    ...
    resources
        ...
        .set("ProductVersion", "0.1.0-alpha.2")
        .set("FileVersion", "0.1.0.2")
        .set("OriginalFilename", "promplet.exe")
        .set("LegalCopyright", "Copyright © 2026 TylerSystems")
        .set_version_info(VersionInfo::FILEVERSION, 0x0000_0001_0000_0002)
        .set_version_info(VersionInfo::PRODUCTVERSION, 0x0000_0001_0000_0002);
